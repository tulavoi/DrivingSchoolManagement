...
('INV-080544271124', 12, 12000000, 0, 1, GETDATE(), GETDATE()),
('INV-080548271124', 13, 12000000, 0, 1, GETDATE(), GETDATE()),
('INV-080553271124', 9, 12000000, 0, 1, GETDATE(), GETDATE()),
('INV-080558271124', 10, 12000000, 0, 1, GETDATE(), GETDATE()),
('INV-080606271124', 17, 15000000, 0, 1, GETDATE(), GETDATE()),
('INV-080619271124', 11, 12000000, 0, 1, GETDATE(), GETDATE());
...
(9, '27/11/2024 08:10:45', 7000000, 'Banking', GETDATE(), NULL);
