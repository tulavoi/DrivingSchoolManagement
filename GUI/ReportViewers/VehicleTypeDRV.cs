...
{
    public partial class VehicleTypeDRV : Form
    {
        public VehicleTypeDRV()
        {
            InitializeComponent();
        }
        private void DisplayReport()
        {
            try
            {
                ...
                var Data = VehicleService.GetVehiclesTypeD(); // Lấy tất cả các phương tiện
        ...
        private void VehicleTypeDRV_Load(object sender, EventArgs e)
        {
