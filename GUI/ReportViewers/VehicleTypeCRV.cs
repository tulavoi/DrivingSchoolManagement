...
{
    public partial class VehicleTypeCRV : Form
    {
        public VehicleTypeCRV()
        {
            InitializeComponent();
        }
        private void DisplayReport()
        {
            try
            {
                ...
                var Data = VehicleService.GetVehiclesTypeC(); // Lấy tất cả các phương tiện
        ...
        private void VehicleTypeCRV_Load(object sender, EventArgs e)
        {
