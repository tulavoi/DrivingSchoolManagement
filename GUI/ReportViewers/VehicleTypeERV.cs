...
{
    public partial class VehicleTypeERV : Form
    {
        public VehicleTypeERV()
        {
            InitializeComponent();
        }
        private void DisplayReport()
        {
            try
            {
                ...
                var Data = VehicleService.GetVehiclesTypeE(); // Lấy tất cả các phương tiện
        ...
        private void VehicleTypeERV_Load(object sender, EventArgs e)
        {
